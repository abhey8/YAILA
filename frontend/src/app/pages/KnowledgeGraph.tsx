            ...
            <GlassCard className="p-6 study-panel">
              ...
              {selectedNode ? (
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl border border-[var(--border)] bg-[color-mix(in_srgb,var(--surface-1)_76%,var(--surface-2))] p-4 space-y-2">
                    <p className="text-sm text-[var(--foreground-soft)] leading-6">
                      Importance estimates how central this topic is across the document, based on how often it appears and how many graph relationships connect through it.
                    </p>
                    <p className="text-sm text-[var(--foreground-soft)] leading-6">
                      Difficulty is an approximate study-load score using concept complexity, chunk density, and dependency structure. It is a guidance signal, not an exam-style grade.
                    </p>
                  </div>
                </div>
              ) : (
